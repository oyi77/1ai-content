...
from services.ebook.pipeline.comics.script_engine import ComicsScriptEngine, PANEL_SCHEMA
        ...
        side_effect=[
            # First call: characters
            {
                "characters": [
                    {
                        "name": "Akira",
                        "visual_description": "spiky black hair, red jacket",
                        "role": "protagonist",
                    }
                ]
            },
