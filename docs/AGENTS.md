...
## Purpose
Product documentation, system prompts, pricing schemes, workflow descriptions, and competitor analysis.

## Key Files

| File | Description |
|------|-------------|
| `MASTER_PROMPT.md` | Master system prompt for AI video generation |
