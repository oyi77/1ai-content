...
export const CHARACTER_KEYWORDS = [
  'person', 'woman', 'man', 'model', 'figure', 'people',
  'character', 'individual', 'portrait', 'face', 'hands',
];

export const PRODUCT_KEYWORDS = [
  'product', 'bottle', 'package', 'item', 'object', 'brand',
  'label', 'box', 'bag', 'container', 'device', 'gadget',
];
