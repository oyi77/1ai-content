...
import {
  ...
  IMAGE_PROVIDERS_SORTED,
} from "@/config/providers";
import { ProviderError } from "@/utils/app-errors";
import { z } from "zod";
import { zodToJsonSchema } from "zod-to-json-schema";

const playgroundTextSchema = zodToJsonSchema(
  z.object({
...
const playgroundImageSchema = zodToJsonSchema(
  z.object({
...
const playgroundVideoSchema = zodToJsonSchema(
  z.object({
    prompt: z.string().min(1).max(5000),
    provider: z.string().optional(),
