...
export function getProviders() {
  return [
    ...
    },
    {
      key: "agnes_video",
      name: "Agnes Video",
      enabled: !!getConfig().AGNES_API_KEYS,
      supportsRefImage: false,
      maxDuration: 5,
      generate: generateViaAgnes,
    },
    {
      key: "mpt",
      name: "MoneyPrinterTurbo (Stock Footage)",
      enabled: !!getConfig().PEXELS_API_KEYS || !!getConfig().PEXELS_API_KEY,
      supportsRefImage: false,
      maxDuration: 600,
      generate: generateViaMPT,
    },
  ];
}
