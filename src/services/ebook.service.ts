/**
 * Ebook Service — Integration with 1ai-content Python API
 *
 * Provides ebook generation capabilities via the absorbed ebook generator
 * (services/ebook/), served through the content API on port 8767.
 */
