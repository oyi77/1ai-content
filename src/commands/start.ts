            ...
            reply_markup: {
              inline_keyboard: [
                [
                  ...
                  {
                    text: "🎥 Creator",
                    callback_data: "persona_set_content_creator",
                  },
                ],
                [
                  {
                    text: "🎬 Director",
                    callback_data: "persona_set_movie_director",
                  },
                  {
                    text: "🎌 Anime",
                    callback_data: "persona_set_anime_studio",
                  },
                ],
                [
                  {
                    text: "💼 Corporate",
                    callback_data: "persona_set_corporate",
                  },
