...
export async function showMainMenu(
  ...
  try {
    ...
    const rows: InlineKeyboardButton[][] = [
      ...
      [
        {
          text: t("menu.btn_create_video", lang),
          callback_data: "create_video_new",
        },
        {
          text: t("menu.btn_create_image", lang),
      ...
      [
        ...
        {
          text: t("menu.btn_storyboard", lang),
    ...
    if (webAppUrl) {
      rows.push([
        {
          text: t("menu.btn_web_dashboard", lang),
