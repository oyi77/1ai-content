...
| `monitoring/README.md` | Panduan Grafana: port 3002 (container :3000) — ⚠️ host :3002 bentrok dengan bot PM2; ubah mapping compose ke :3003 sebelum pakai profile monitoring (lihat README) |
