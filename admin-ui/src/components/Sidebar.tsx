...
const categories: SidebarCategory[] = [
  ...
  },
  {
    ...
    iconKey: "video",
    items: [
      { label: "Captions", path: "/captions", type: "react" },
      { label: "Carousel", path: "/analytics/carousel", type: "react" },
      { label: "Looping Video", path: "/looping", type: "react" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Personas", path: "/personas", type: "react" },
      { label: "AI Config", path: "/ai-config", type: "react" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "TTS Voice", path: "/tts", type: "react" },
      { label: "Music Generator", path: "/music", type: "react" },
      { label: "Autopilot", path: "/autopilot", type: "react" },
      { label: "Channel Analysis", path: "/analyze", type: "react" },
    ],
  },
  {
    label: "System",
